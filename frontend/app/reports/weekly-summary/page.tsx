      ...
      if (reports) {
        ...
        const classSummaries = Array.from(classMap.values())
          .map((cls) => ({
            ...cls,
            avgAttendance:
              cls.reportsSubmitted > 0
                ? Math.round(cls.avgAttendance / cls.reportsSubmitted)
                : 0,
          }))
        ...
        const totalStudents = reports.reduce(
          (sum: number, r: any) => sum + r.total_learners,
          0,
        );
        const totalPresent = reports.reduce(
          (sum: number, r: any) => sum + r.present_learners,
          0,
        );
        ...
        setSummary({
          ...
          totalStudents: Math.round(
            totalStudents / (dailyBreakdown.length || 1),
          ),
          avgAttendance:
            totalStudents > 0
          ...
          disciplineIncidents: reports.filter((r: any) => r.discipline_issue)
            .length,
          parentCommunications: reports.filter(
            (r: any) => r.parent_communication,
          ).length,
          classSummaries,
          dailyBreakdown,
        });
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 print:hidden">
        <div>
          <Link
            ...
            className="text-accent hover:text-accent-dark text-sm mb-2 inline-block"
          >
            ← Back to Dashboard
          </Link>
      ...
      <div ref={printRef} className="print:p-8">
        ...
        <div className="hidden print:block mb-8 text-center">
          <h1 className="text-2xl font-bold">
            Lelani School - Weekly Summary Report
          </h1>
          <p className="text-gray-600">
            Week of {format(currentWeekStart, "MMMM dd")} -{" "}
            {format(
              endOfWeek(currentWeekStart, { weekStartsOn: 1 }),
              "MMMM dd, yyyy",
            )}
        ...
        {!summary || summary.totalReports === 0 ? (
          <div className="bg-white rounded-xl shadow-md p-8 text-center">
            ...
            <p className="text-gray-500 text-lg">
              No reports submitted for this week
            </p>
          </div>
        ) : (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 print:grid-cols-4">
              <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-5 text-white print:bg-blue-100 print:text-blue-800">
                <p className="text-blue-100 text-sm print:text-blue-600">
                  Total Reports
                </p>
              ...
              <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-5 text-white print:bg-green-100 print:text-green-800">
                <p className="text-green-100 text-sm print:text-green-600">
                  Avg Attendance
                </p>
                <p className="text-3xl font-bold mt-1">
              ...
              <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-xl p-5 text-white print:bg-yellow-100 print:text-yellow-800">
                <p className="text-yellow-100 text-sm print:text-yellow-600">
                  Health Incidents
                </p>
                <p className="text-3xl font-bold mt-1">
                  {summary.healthIncidents}
                </p>
              </div>
              <div className="bg-gradient-to-br from-red-500 to-red-600 rounded-xl p-5 text-white print:bg-red-100 print:text-red-800">
                <p className="text-red-100 text-sm print:text-red-600">
                  Discipline Issues
                </p>
                <p className="text-3xl font-bold mt-1">
                  {summary.disciplineIncidents}
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 print:shadow-none print:border print:border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {summary.classSummaries.length > 0 && (
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    ...
                    <p className="text-lg font-bold text-green-800 mt-1">
                      {
                        summary.classSummaries.reduce((a, b) =>
                          a.avgAttendance > b.avgAttendance ? a : b,
                        ).className
                      }
                    </p>
                ...
                {/* Needs Attention */}
                {summary.classSummaries.filter((c) => c.avgAttendance < 75)
                  .length > 0 ? (
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  ...
                  <p className="text-lg font-bold text-yellow-800 mt-1">
                    {summary.healthIncidents + summary.disciplineIncidents}{" "}
                    total incidents
                  </p>
                  <p className="text-sm text-yellow-700">
                    {summary.healthIncidents} health,{" "}
                    {summary.disciplineIncidents} discipline
                  </p>
                </div>
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-purple-700">Logged this week</p>
                </div>
              </div>
            </div>
            ...
            <div className="hidden print:block mt-8 pt-4 border-t border-gray-200 text-center text-sm text-gray-500">
              ...
              <p>
                This report was automatically generated. For questions, contact
                the administration.
              </p>
            </div>
          </div>
